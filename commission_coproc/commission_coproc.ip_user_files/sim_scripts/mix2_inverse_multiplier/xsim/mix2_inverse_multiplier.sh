...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_15 -L mult_gen_v12_0_24 -L secureip -L xpm --snapshot mix2_inverse_multiplier xil_defaultlib.mix2_inverse_multiplier -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mix2_inverse_multiplier -key {Behavioral:sim_1:Functional:mix2_inverse_multiplier} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mix2_inverse_multiplier.wdb xsim.dir libdpi.so)
