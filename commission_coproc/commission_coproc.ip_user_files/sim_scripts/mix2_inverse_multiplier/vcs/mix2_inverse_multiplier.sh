...
design_libs=(xbip_utils_v3_0_15 mult_gen_v12_0_24 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mix2_inverse_multiplier -o mix2_inverse_multiplier_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mix2_inverse_multiplier_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mix2_inverse_multiplier_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mix2_inverse_multiplier_simv.daidir vcs_lib c.obj)
