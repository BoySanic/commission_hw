...
#
# Script generated by Vivado on Tue Jun 23 17:35:48 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mix2_inverse_multiplier.sh
...
#
# Usage        : mix2_inverse_multiplier.sh
#                mix2_inverse_multiplier.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mix2_inverse_multiplier.sh [-rerun]
#                mix2_inverse_multiplier.sh [-reset_run]
#                mix2_inverse_multiplier.sh [-clean]
#                mix2_inverse_multiplier.sh [-reset_log]
#                mix2_inverse_multiplier.sh [-help]
#
...
#                script (type 'mix2_inverse_multiplier.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_15 -libname mult_gen_v12_0_24 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_15 mult_gen_v12_0_24 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mix2_inverse_multiplier.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mix2_inverse_multiplier.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mix2_inverse_multiplier
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mix2_inverse_multiplier -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mix2_inverse_multiplier_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mix2_inverse_multiplier.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mix2_inverse_multiplier.sh [-help]\n\
Usage: mix2_inverse_multiplier.sh [-step]\n\
Usage: mix2_inverse_multiplier.sh [-lib_map_path]\n\
Usage: mix2_inverse_multiplier.sh [-rerun]\n\
Usage: mix2_inverse_multiplier.sh [-reset_run]\n\
Usage: mix2_inverse_multiplier.sh [-clean]\n\
Usage: mix2_inverse_multiplier.sh [-reset_log]\n\
Usage: mix2_inverse_multiplier.sh [-keep_index]\n\
Usage: mix2_inverse_multiplier.sh [-noclean_files]\n\n\
