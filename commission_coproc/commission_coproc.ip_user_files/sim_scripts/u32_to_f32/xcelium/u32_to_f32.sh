...
#
# Script generated by Vivado on Tue Jun 23 16:44:47 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : u32_to_f32.sh
...
#
# Usage        : u32_to_f32.sh
#                u32_to_f32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                u32_to_f32.sh [-rerun]
#                u32_to_f32.sh [-reset_run]
#                u32_to_f32.sh [-clean]
#                u32_to_f32.sh [-reset_log]
#                u32_to_f32.sh [-help]
#
...
#                script (type 'u32_to_f32.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_15 -libname axi_utils_v2_0_11 -libname xbip_pipe_v3_0_11 -libname xbip_dsp48_wrapper_v3_0_7 -libname mult_gen_v12_0_24 -libname floating_point_v7_1_21 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_15 axi_utils_v2_0_11 xbip_pipe_v3_0_11 xbip_dsp48_wrapper_v3_0_7 mult_gen_v12_0_24 floating_point_v7_1_21 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "u32_to_f32.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./u32_to_f32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work floating_point_v7_1_21 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.u32_to_f32
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.u32_to_f32 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log u32_to_f32_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./u32_to_f32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: u32_to_f32.sh [-help]\n\
Usage: u32_to_f32.sh [-step]\n\
Usage: u32_to_f32.sh [-lib_map_path]\n\
Usage: u32_to_f32.sh [-rerun]\n\
Usage: u32_to_f32.sh [-reset_run]\n\
Usage: u32_to_f32.sh [-clean]\n\
Usage: u32_to_f32.sh [-reset_log]\n\
Usage: u32_to_f32.sh [-keep_index]\n\
Usage: u32_to_f32.sh [-noclean_files]\n\n\
