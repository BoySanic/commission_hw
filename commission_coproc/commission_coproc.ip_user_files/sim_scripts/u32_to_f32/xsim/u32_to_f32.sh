...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_15 -L axi_utils_v2_0_11 -L xbip_pipe_v3_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_24 -L floating_point_v7_1_21 -L secureip -L xpm --snapshot u32_to_f32 xil_defaultlib.u32_to_f32 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim u32_to_f32 -key {Behavioral:sim_1:Functional:u32_to_f32} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb u32_to_f32.wdb xsim.dir libdpi.so)
