...
design_libs=(xbip_utils_v3_0_15 axi_utils_v2_0_11 xbip_pipe_v3_0_11 xbip_dsp48_wrapper_v3_0_7 mult_gen_v12_0_24 floating_point_v7_1_21 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.u32_to_f32 -o u32_to_f32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./u32_to_f32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key u32_to_f32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc u32_to_f32_simv.daidir vcs_lib c.obj)
