...
#
# Script generated by Vivado on Wed Jun 24 19:51:46 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : add_goldenratio.sh
...
#
# Usage        : add_goldenratio.sh
#                add_goldenratio.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                add_goldenratio.sh [-rerun]
#                add_goldenratio.sh [-reset_run]
#                add_goldenratio.sh [-clean]
#                add_goldenratio.sh [-reset_log]
#                add_goldenratio.sh [-help]
#
...
#                script (type 'add_goldenratio.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_15 -libname c_reg_fd_v12_0_11 -libname xbip_dsp48_wrapper_v3_0_7 -libname xbip_pipe_v3_0_11 -libname c_addsub_v12_0_21 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_15 c_reg_fd_v12_0_11 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_11 c_addsub_v12_0_21 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "add_goldenratio.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./add_goldenratio.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.add_goldenratio
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.add_goldenratio -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log add_goldenratio_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./add_goldenratio.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: add_goldenratio.sh [-help]\n\
Usage: add_goldenratio.sh [-step]\n\
Usage: add_goldenratio.sh [-lib_map_path]\n\
Usage: add_goldenratio.sh [-rerun]\n\
Usage: add_goldenratio.sh [-reset_run]\n\
Usage: add_goldenratio.sh [-clean]\n\
Usage: add_goldenratio.sh [-reset_log]\n\
Usage: add_goldenratio.sh [-keep_index]\n\
Usage: add_goldenratio.sh [-noclean_files]\n\n\
