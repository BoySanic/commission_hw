...
design_libs=(xbip_utils_v3_0_15 c_reg_fd_v12_0_11 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_11 c_addsub_v12_0_21 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.add_goldenratio -o add_goldenratio_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./add_goldenratio_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key add_goldenratio_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc add_goldenratio_simv.daidir vcs_lib c.obj)
