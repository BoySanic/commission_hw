...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sub_i32 -o sub_i32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sub_i32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sub_i32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sub_i32_simv.daidir vcs_lib c.obj)
