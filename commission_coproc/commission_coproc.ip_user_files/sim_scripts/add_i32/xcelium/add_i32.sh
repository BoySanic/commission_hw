...
#
# Script generated by Vivado on Fri Jun 26 23:48:56 PDT 2026
...
#
# Usage        : add_i32.sh
#                add_i32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                add_i32.sh [-rerun]
#                add_i32.sh [-reset_run]
#                add_i32.sh [-clean]
#                add_i32.sh [-reset_log]
#                add_i32.sh [-help]
#
...
#                script (type 'add_i32.sh -help' for more information).
#
...
# script info
echo -e "add_i32.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./add_i32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.add_i32
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.add_i32 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log add_i32_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./add_i32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: add_i32.sh [-help]\n\
Usage: add_i32.sh [-step]\n\
Usage: add_i32.sh [-lib_map_path]\n\
Usage: add_i32.sh [-rerun]\n\
Usage: add_i32.sh [-reset_run]\n\
Usage: add_i32.sh [-clean]\n\
Usage: add_i32.sh [-reset_log]\n\
Usage: add_i32.sh [-keep_index]\n\
Usage: add_i32.sh [-noclean_files]\n\n\
