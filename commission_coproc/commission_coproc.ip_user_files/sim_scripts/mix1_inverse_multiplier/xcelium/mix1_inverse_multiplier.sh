...
#                script (type 'mix1_inverse_multiplier.sh -help' for more information).
#
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mix1_inverse_multiplier
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mix1_inverse_multiplier -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mix1_inverse_multiplier_sc.so .tmp_log xcelium_lib waves.shm c.obj)
