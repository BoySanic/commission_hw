...
#
# Script generated by Vivado on Wed Jun 24 09:12:44 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mix1_multiplier.sh
...
#
# Usage        : mix1_multiplier.sh
#                mix1_multiplier.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mix1_multiplier.sh [-rerun]
#                mix1_multiplier.sh [-reset_run]
#                mix1_multiplier.sh [-clean]
#                mix1_multiplier.sh [-reset_log]
#                mix1_multiplier.sh [-help]
#
...
#                script (type 'mix1_multiplier.sh -help' for more information).
#
...
# script info
echo -e "mix1_multiplier.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mix1_multiplier.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mix1_multiplier
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mix1_multiplier -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mix1_multiplier_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mix1_multiplier.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mix1_multiplier.sh [-help]\n\
Usage: mix1_multiplier.sh [-step]\n\
Usage: mix1_multiplier.sh [-lib_map_path]\n\
Usage: mix1_multiplier.sh [-rerun]\n\
Usage: mix1_multiplier.sh [-reset_run]\n\
Usage: mix1_multiplier.sh [-clean]\n\
Usage: mix1_multiplier.sh [-reset_log]\n\
Usage: mix1_multiplier.sh [-keep_index]\n\
Usage: mix1_multiplier.sh [-noclean_files]\n\n\
