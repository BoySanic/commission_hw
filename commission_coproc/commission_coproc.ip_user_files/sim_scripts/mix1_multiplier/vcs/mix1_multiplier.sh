...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mix1_multiplier -o mix1_multiplier_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mix1_multiplier_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mix1_multiplier_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mix1_multiplier_simv.daidir vcs_lib c.obj)
