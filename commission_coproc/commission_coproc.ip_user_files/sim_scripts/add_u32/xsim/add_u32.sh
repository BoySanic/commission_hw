...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_15 -L c_reg_fd_v12_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_11 -L c_addsub_v12_0_21 -L secureip -L xpm --snapshot add_u32 xil_defaultlib.add_u32 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim add_u32 -key {Behavioral:sim_1:Functional:add_u32} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb add_u32.wdb xsim.dir libdpi.so)
