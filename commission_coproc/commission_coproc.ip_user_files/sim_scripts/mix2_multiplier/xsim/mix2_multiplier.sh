...
#
# Script generated by Vivado on Wed Jun 24 09:12:58 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mix2_multiplier.sh
...
#
# Usage        : mix2_multiplier.sh
#                mix2_multiplier.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mix2_multiplier.sh [-rerun]
#                mix2_multiplier.sh [-reset_run]
#                mix2_multiplier.sh [-clean]
#                mix2_multiplier.sh [-reset_log]
#                mix2_multiplier.sh [-help]
#
...
# script info
echo -e "mix2_multiplier.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mix2_multiplier.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_15 -L mult_gen_v12_0_24 -L secureip -L xpm --snapshot mix2_multiplier xil_defaultlib.mix2_multiplier -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mix2_multiplier -key {Behavioral:sim_1:Functional:mix2_multiplier} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mix2_multiplier.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mix2_multiplier.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mix2_multiplier.sh [-help]\n\
Usage: mix2_multiplier.sh [-step]\n\
Usage: mix2_multiplier.sh [-lib_map_path]\n\
Usage: mix2_multiplier.sh [-rerun]\n\
Usage: mix2_multiplier.sh [-reset_run]\n\
Usage: mix2_multiplier.sh [-clean]\n\
Usage: mix2_multiplier.sh [-reset_log]\n\
Usage: mix2_multiplier.sh [-keep_index]\n\
Usage: mix2_multiplier.sh [-noclean_files]\n\n\
