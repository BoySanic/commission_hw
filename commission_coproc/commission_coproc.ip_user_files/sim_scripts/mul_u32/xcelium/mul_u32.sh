...
#
# Script generated by Vivado on Mon Jun 29 09:27:58 PDT 2026
...
#
# Usage        : mul_u32.sh
#                mul_u32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mul_u32.sh [-rerun]
#                mul_u32.sh [-reset_run]
#                mul_u32.sh [-clean]
#                mul_u32.sh [-reset_log]
#                mul_u32.sh [-help]
#
...
#                script (type 'mul_u32.sh -help' for more information).
#
...
# script info
echo -e "mul_u32.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mul_u32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mul_u32
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mul_u32 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mul_u32_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mul_u32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mul_u32.sh [-help]\n\
Usage: mul_u32.sh [-step]\n\
Usage: mul_u32.sh [-lib_map_path]\n\
Usage: mul_u32.sh [-rerun]\n\
Usage: mul_u32.sh [-reset_run]\n\
Usage: mul_u32.sh [-clean]\n\
Usage: mul_u32.sh [-reset_log]\n\
Usage: mul_u32.sh [-keep_index]\n\
Usage: mul_u32.sh [-noclean_files]\n\n\
