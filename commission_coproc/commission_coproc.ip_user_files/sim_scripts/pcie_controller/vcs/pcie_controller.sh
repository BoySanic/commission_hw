...
#
# Script generated by Vivado on Sat Jun 27 15:59:32 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pcie_controller.sh
...
#
# Usage        : pcie_controller.sh
#                pcie_controller.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pcie_controller.sh [-rerun]
#                pcie_controller.sh [-reset_run]
#                pcie_controller.sh [-clean]
#                pcie_controller.sh [-reset_log]
#                pcie_controller.sh [-help]
#
...
#                script (type 'pcie_controller.sh -help' for more information).
#
...
# script info
echo -e "pcie_controller.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pcie_controller.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../.vivado/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../.vivado/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pcie_controller xil_defaultlib.glbl -o pcie_controller_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pcie_controller_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/boysanic/commission_hw/commission_coproc/commission_coproc.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key pcie_controller_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pcie_controller_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pcie_controller.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pcie_controller.sh [-help]\n\
Usage: pcie_controller.sh [-step]\n\
Usage: pcie_controller.sh [-lib_map_path]\n\
Usage: pcie_controller.sh [-rerun]\n\
Usage: pcie_controller.sh [-reset_run]\n\
Usage: pcie_controller.sh [-clean]\n\
Usage: pcie_controller.sh [-reset_log]\n\
Usage: pcie_controller.sh [-keep_index]\n\
Usage: pcie_controller.sh [-noclean_files]\n\n\
